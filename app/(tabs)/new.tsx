...
const NewActivityScreen: React.FC = () => {
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => strengthTrainRef.current?.present()}
      >
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => addMealRef.current?.present()}
      >
        <MaterialCommunityIcons
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => weighInRef.current?.present()}
      >
        <MaterialCommunityIcons
          name="scale-bathroom"
          size={75}
      ...
      {/* Bottom sheets mount under the root provider in _layout.tsx */}
