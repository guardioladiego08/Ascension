...
const TopMetricCards: React.FC = () => {
  ...
  const weightsSubtitle = loading
    ? 'Loading...'
    : `${weightsSessions} session${weightsSessions === 1 ? '' : 's'} · ${weightsHours} hrs`;

  const weightsValue = loading ? '—' : String(weightsSessions || 0);

  return (
    <View style={styles.metricGrid}>
      {/* Weights – from Supabase */}
