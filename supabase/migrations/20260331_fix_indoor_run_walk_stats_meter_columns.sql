-- Restore meter-based indoor run/walk summary rollups after the delete-safety trigger migration
-- reintroduced legacy total_miles_* weekly_summary writes.
...
begin
  if exists (
    ...
    values (
      '20260331_fix_indoor_run_walk_stats_meter_columns',
      'Restored indoor run/walk weekly_summary stats rollups to meter-based columns after a delete-safety trigger regression reintroduced total_miles_* writes.'
    )
