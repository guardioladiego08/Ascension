// components/cardio/modals/OutdoorActivityModal.tsx
// Outdoor summary modal template (e.g., GPS run). Add map later if needed.
...
export default function OutdoorActivityModal({
  activity,
  onClose,
}: {
  ...
  return (
    <View style={styles.backdrop}>
      <View style={styles.sheet}>
        <Text style={styles.title}>Outdoor Summary</Text>
        ...
        <Text style={styles.small}>Surface: Road/Path (sample)</Text>
